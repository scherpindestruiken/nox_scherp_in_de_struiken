...
export default function Error({ error, reset }: { error: Error & { digest?: string }, reset: () => void }) {
  return (
    <main style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#0d1b0d",color:"#d6c98b"}}>
      <div style={{background:"#132313",border:"1px solid rgba(214,201,139,0.25)",borderRadius:12,padding:24,width:600,maxWidth:"90%"}}>
        <h1 style={{marginTop:0}}>Er ging iets mis op /login</h1>
